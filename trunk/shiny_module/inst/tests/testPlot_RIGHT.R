...
test_that("Check script generation", {
  ...
  expect_identical(temp$scriptArray, c("var axis1 = new Axis(1, Theoph, 'Time', 'conc', {});", 
                                       ...
                                       "var point1 = new Dot(axis2, Theoph, 'Time', 'conc', {baseColor: 'black'});"))
  ...
  expect_identical(temp$scriptArray, c("var axis1 = new Axis(1, Theoph, 'Time', 'conc', {});", 
                                       ...
                                       "var line1 = new Line(axis3, lineObj1, 'x1', 'x2', 'y1', 'y2', {baseColor: 'black'});"))
  ...
  expect_identical(temp$scriptArray, c("var axis1 = new Axis(1, Theoph, 'Time', 'conc', {});", 
                                       ...
                                       "var line2 = new Line(axis4, lineObj2, 'x1', 'x2', 'y1', 'y2', {baseColor: 'black'});",
                                       "var point2 = new Dot(axis4, Theoph, 'Time', 'conc', {baseColor: 'black'});"))
