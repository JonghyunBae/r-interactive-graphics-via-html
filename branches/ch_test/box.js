       ...
       //      a.sort();
        //     document.write(findMedianValue(a), '<br />');
         ...
         //   alert(xMainValueArr.length);
            ...
            for(var i = 0; i < this.node.length ; i++) //for discontinuous data, this.xPlotArr.length is used, for continuous data, it should be just 1.
            {
                document.write('<br>', this.node[i].getName());
            }
